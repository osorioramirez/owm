        ...
        options: {
          ...
          plugins: [
            ...
            [
              'react-intl',
              {
                messagesDir: path.resolve(__dirname, '../src/infrastructure/intl/messages'),
...
const clientConfig = {
  ...
  entry: {
    client: ['babel-polyfill', './src/infrastructure/client.js'],
  },
...
const serverConfig = {
  ...
  entry: {
    server: ['babel-polyfill', './src/infrastructure/server.js'],
  },
